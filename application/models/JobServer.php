 ...
 *
 */
class JobServerModel extends ControlMysql{
    const CLASS_NAME = __CLASS__;
    const TABLE_NAME = "crontab_serverlist";
     ...
     * @return boolean
     */
    public function beginTransaction($work_name = 'default') {
        $result = parent::beginTransaction ( $work_name );
        return $result;
    }
    /**
     * 提交事务
     ...
     * @return boolean
     */
    public function commit($work_name = 'default') {
        $result = parent::commit ( $work_name );
        return $result;
    }
    /**
     * 回滚事务
     ...
     * @return boolean
     */
    public function rollback($work_name = 'default') {
        $result = parent::rollback ( $work_name );
        return $result;
    }
}